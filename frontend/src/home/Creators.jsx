              ...
              <div key={element._id}>
                <div className="">
                  <img
                    ...
                    alt="blog"
                    className="md:w-56 md:h-56 sm:h-40 sm:w-40  my-2 shadow-lg object-cover border border-black rounded-full items-center "
                  />
                  <div className="text-center sm:ml-[-100px] md:ml-[-100px]">
                    <p>{element.name}</p>
