  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <p>
        ...
        create intuitive and visually appealing interfaces. <br></br>
        Back-End: Proficient in server-side technologies including Node.js and
        Express.js. Experienced with database management using MySQL and MongoDB. 
      ...
      <p>
        ...
        Continuously learning and adapting to emerging technologies and industry trends to stay ahead in
        the fast-evolving tech landscape.
      </p>
      <br />
      <span>
      {profile?.user?.name} is dedicated to leveraging the expertise to contribute to
        innovative projects and drive technological advancements. Whether
        working on front-end interfaces or back-end logic, {profile?.user?.name} is passionate
      ...
      <p>
        Beyond the professional achievements, {profile?.user?.name} is deeply passionate about creativity, painting and designing.
        Besides, also a fan of badminton and
        holds immense admiration for <strong> PV Sindhu.</strong> 
      </p>
    </div>
  );
}
